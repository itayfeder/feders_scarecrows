...
public class OcelotScarecrowRenderer extends LivingEntityRenderer<TemplateScarecrow, OcelotScarecrowModel<TemplateScarecrow>> {
    private static final ResourceLocation DEFAULT = new ResourceLocation(FedersScarecrowsMod.MOD_ID, "textures/entity/scarecrow/ocelot_scarecrow.png");

    public OcelotScarecrowRenderer(EntityRendererProvider.Context p_174289_) {
        super(p_174289_, new OcelotScarecrowModel<>(p_174289_.bakeLayer(ModModelLayers.OCELOT_SCARECROW)), 0.5F);
    }
