...
public class WolfScarecrowRenderer extends LivingEntityRenderer<TemplateScarecrow, WolfScarecrowModel<TemplateScarecrow>> {
    private static final ResourceLocation DEFAULT = new ResourceLocation(FedersScarecrowsMod.MOD_ID, "textures/entity/scarecrow/wolf_scarecrow.png");

    public WolfScarecrowRenderer(EntityRendererProvider.Context p_174289_) {
        super(p_174289_, new WolfScarecrowModel<>(p_174289_.bakeLayer(ModModelLayers.WOLF_SCARECROW)), 0.5F);
    }
