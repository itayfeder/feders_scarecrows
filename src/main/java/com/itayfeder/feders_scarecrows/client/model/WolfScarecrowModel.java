...
public class WolfScarecrowModel <T extends TemplateScarecrow> extends AgeableListModel<T> {
    private final ModelPart head;
    private final ModelPart body;
    private final ModelPart leftArm;
    private final ModelPart rightArm;

    public WolfScarecrowModel(ModelPart p_170490_) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create()
                        ...
                        .texOffs(0, 38).addBox(-5.0F, -9.0F, -4.5F, 10.0F, 10.0F, 9.0F)
                        .texOffs(32, 25).addBox(-2.0F, -6.0F, -8.5F, 4.0F, 3.0F, 4.0F)
                        .texOffs(34, 34).addBox(2.0F, -12.0F, 0.5F, 3.0F, 3.0F, 0.0F)
                        .texOffs(32, 32).addBox(2.0F, -12.0F, -1.5F, 3.0F, 0.0F, 2.0F)
                        .texOffs(34, 34).addBox(-5.0F, -12.0F, 0.5F, 3.0F, 3.0F, 0.0F)
                        .texOffs(32, 32).addBox(-5.0F, -12.0F, -1.5F, 3.0F, 0.0F, 2.0F)
