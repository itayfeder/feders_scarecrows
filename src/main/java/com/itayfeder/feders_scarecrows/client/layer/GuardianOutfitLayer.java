...
public class GuardianOutfitLayer extends RenderLayer<Scarecrow, ScarecrowModel<Scarecrow>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(FedersScarecrowsMod.MOD_ID, "textures/entity/scarecrow/guardian_scarecrow.png");
    private final GuardianOutfitModel<Scarecrow> model;

    public GuardianOutfitLayer(RenderLayerParent<Scarecrow, ScarecrowModel<Scarecrow>> p_174533_, EntityModelSet p_174534_) {
        super(p_174533_);
        this.model = new GuardianOutfitModel<>(p_174534_.bakeLayer(ModModelLayers.GUARDIAN_OUTFIT));
    }
    ...
    public void render(PoseStack p_117421_, MultiBufferSource p_117422_, int p_117423_, Scarecrow entity, float p_117425_, float p_117426_, float p_117427_, float p_117428_, float p_117429_, float p_117430_) {
        if (entity.getScarecrowType() == ScarecrowType.GUARDIAN) {
