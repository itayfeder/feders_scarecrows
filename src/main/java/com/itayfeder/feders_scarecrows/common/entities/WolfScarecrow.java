...
public class WolfScarecrow extends TemplateScarecrow {
    ...
    public WolfScarecrow(Level p_31556_, double p_31557_, double p_31558_, double p_31559_) {
        super(EntityTypeInit.WOLF_SCARECROW, p_31556_);
        this.setPos(p_31557_, p_31558_, p_31559_);
    }

    public WolfScarecrow(EntityType<WolfScarecrow> wolfScarecrowEntityType, Level level) {
        super(wolfScarecrowEntityType, level);
    }

    public ItemStack getPickResult() {
        return new ItemStack(ItemInit.WOLF_SCARECROW);
    }
